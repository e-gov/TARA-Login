...
class IdCardLoginControllerTest extends BaseTest {
    ...
    void handleRequest_NonceNotFoundInSession_Fails() {
        ...
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=null, subject=null, firstName=null, lastName=null, ocspUrl=null, authenticationType=null, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=INVALID_REQUEST)", sessionId));
    }
    ...
    void handleRequest_InvalidAuthTokenFormat_Fails() {
        ...
        assertMessageWithMarkerIsLoggedOnce(ErrorHandler.class, WARN, "Session has been invalidated: " + sessionId, "tara.session=TaraSession(sessionId=" + sessionId + ", state=AUTHENTICATION_FAILED, loginRequestInfo=TaraSession.LoginRequestInfo(");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=null, subject=null, firstName=null, lastName=null, ocspUrl=null, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=INVALID_REQUEST)", sessionId));
    }
    ...
    void handleRequest_UnverifiedCertificateExpired_Fails() throws CertificateEncodingException {
        ...
        assertMessageWithMarkerIsLoggedOnce(ErrorHandler.class, WARN, "Session has been invalidated: " + sessionId, "tara.session=TaraSession(sessionId=" + sessionId + ", state=AUTHENTICATION_FAILED, loginRequestInfo=TaraSession.LoginRequestInfo(");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=null, subject=null, firstName=null, lastName=null, ocspUrl=null, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=IDC_CERT_EXPIRED)", sessionId));
    }
    ...
    void handleRequest_UnverifiedCertificateNotYetValid_Fails() throws CertificateEncodingException {
        ...
        assertMessageWithMarkerIsLoggedOnce(ErrorHandler.class, WARN, "Session has been invalidated: " + sessionId, "tara.session=TaraSession(sessionId=" + sessionId + ", state=AUTHENTICATION_FAILED, loginRequestInfo=TaraSession.LoginRequestInfo(");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=null, subject=null, firstName=null, lastName=null, ocspUrl=null, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=IDC_CERT_NOT_YET_VALID)", sessionId));
    }
    ...
    void handleRequest_OcspEnabled_Success() {
        ...
        assertStatisticsIsLoggedOnce(INFO, "Authentication result: EXTERNAL_TRANSACTION", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, authenticationSessionId=%s, errorCode=null)", sessionId));
    }
    ...
    void taraTraceIdOnAllLogsWhen_successfulAuthentication() {
        ...
        assertMessageIsLogged(e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "OCSP certificate validation. Serialnumber=<96454726563488174362096220658227824995>, SubjectDN=<SERIALNUMBER=PNOEE-38001085718, CN=\"JÕEORG,JAAK-KRISTJAN,38001085718\", SURNAME=JÕEORG, GIVENNAME=JAAK-KRISTJAN, C=EE>, issuerDN=<CN=TEST of ESTEID2018, OID.2.5.4.97=NTREE-10747013, O=SK ID Solutions AS, C=EE>",
                "State: NATURAL_PERSON_AUTHENTICATION_CHECK_ESTEID_CERT -> NATURAL_PERSON_AUTHENTICATION_COMPLETED");
        assertMessageWithMarkerIsLoggedOnce(IdCardLoginController.class, INFO, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "Client-side Web eID operation successful", "tara.webeid.extension_version=2.2.0, tara.webeid.native_app_version=2.0.2+565, tara.webeid.status_duration_ms=200, tara.webeid.code=SUCCESS, tara.webeid.auth_token.unverified_certificate=, tara.webeid.auth_token.signature=");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "OCSP request", "http.request.method=GET, url.full=https://localhost:9877/esteid2018, http.request.body.content={\"http.request.body.content\":");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
    ...
    void taraTraceIdOnAllLogsWhen_failedAuthentication() {
        ...
        assertMessageWithMarkerIsLoggedOnce(IdCardLoginController.class, INFO, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "Client-side Web eID operation successful", "tara.webeid.extension_version=2.2.0, tara.webeid.native_app_version=2.0.2+565, tara.webeid.status_duration_ms=200, tara.webeid.code=SUCCESS, tara.webeid.auth_token.unverified_certificate=, tara.webeid.auth_token.signature=");
        assertMessageWithMarkerIsLoggedOnce(ErrorHandler.class, WARN, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "Session has been invalidated: " + sessionId, "tara.session=TaraSession(sessionId=" + sessionId + ", state=AUTHENTICATION_FAILED, loginRequestInfo=TaraSession.LoginRequestInfo(");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "OCSP request", "http.request.method=GET, url.full=https://localhost:9877/esteid2018, http.request.body.content={\"http.request.body.content\":");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "OCSP response: 200", "http.response.status_code=200, http.response.body.content=");
        assertStatisticsIsLoggedOnce(ERROR, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "Authentication result: EXTERNAL_TRANSACTION", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, authenticationSessionId=%s, errorCode=IDC_REVOKED)", sessionId));
        assertStatisticsIsLoggedOnce(ERROR, e -> e.getMDCPropertyMap().getOrDefault(MDC_ATTRIBUTE_KEY_FLOW_TRACE_ID, "missing").equals(taraTraceId),
                "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=IDC_REVOKED)", sessionId));
    }
    ...
    void handleRequest_UnknownCertificate_FailsOcspCheck() {
        ...
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, "OCSP request", "http.request.method=GET, url.full=https://localhost:9877/esteid2018, http.request.body.content={\"http.request.body.content\":");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, "OCSP response: 200", "http.response.status_code=200, http.response.body.content=");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: EXTERNAL_TRANSACTION", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, authenticationSessionId=%s, errorCode=IDC_UNKNOWN)", sessionId));
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=IDC_UNKNOWN)", sessionId));
    }
    ...
    void handleRequest_OcspResponse404WithFallbackService_Success() {
        ...
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, "OCSP response: 200", "http.response.status_code=200, http.response.body.content=");
        assertInfoIsLogged("OCSP certificate validation. Serialnumber=<96454726563488174362096220658227824995>, SubjectDN=<SERIALNUMBER=PNOEE-38001085718, CN=\"JÕEORG,JAAK-KRISTJAN,38001085718\", SURNAME=JÕEORG, GIVENNAME=JAAK-KRISTJAN, C=EE>, issuerDN=<CN=TEST of ESTEID2018, OID.2.5.4.97=NTREE-10747013, O=SK ID Solutions AS, C=EE>");
        assertStatisticsIsLoggedOnce(INFO, "Authentication result: EXTERNAL_TRANSACTION", "StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, ocspUrl=http://aia.demo.sk.ee/esteid2018, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, errorCode=null)");
    }
    ...
    void handleRequest_OcspResponderCertificateIssuerNotTrusted_Error(CertificateStatus certificateStatus, ErrorCode expectedErrorCode) {
        ...
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, "OCSP request", "http.request.method=GET, url.full=https://localhost:9877/esteid2018, http.request.body.content={\"http.request.body.content\":");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, "OCSP response: 200", "http.response.status_code=200, http.response.body.content=");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: EXTERNAL_TRANSACTION", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, authenticationSessionId=%s, errorCode=%s)", sessionId, expectedErrorCode));
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=%s)", sessionId, expectedErrorCode));
    }
    ...
    void handleRequest_OcspResponseBodyMissing_Error() {
        ...
        assertMessageWithMarkerIsLoggedOnce(ErrorHandler.class, WARN, "Session has been invalidated: " + sessionId, "tara.session=TaraSession(sessionId=" + sessionId + ", state=AUTHENTICATION_FAILED, loginRequestInfo=TaraSession.LoginRequestInfo(");
        assertMessageWithMarkerIsLoggedOnce(OCSPValidator.class, INFO, "OCSP request", "http.request.method=GET, url.full=https://localhost:9877/esteid2018, http.request.body.content={\"http.request.body.content\":");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: EXTERNAL_TRANSACTION", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, authenticationSessionId=%s, errorCode=INTERNAL_ERROR)", sessionId));
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/esteid2018, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=INTERNAL_ERROR)", sessionId));
    }
    ...
    void handleRequest_OcspServiceNotAvailable_Error() {
        ...
        assertMessageWithMarkerIsLoggedOnce(IdCardLoginController.class, INFO, "Client-side Web eID operation successful", "tara.webeid.extension_version=2.2.0, tara.webeid.native_app_version=2.0.2+565, tara.webeid.status_duration_ms=200, tara.webeid.code=SUCCESS, tara.webeid.auth_token.unverified_certificate=, tara.webeid.auth_token.signature=");
        assertMessageWithMarkerIsLoggedOnce(ErrorHandler.class, WARN, "Session has been invalidated: " + sessionId, "tara.session=TaraSession(sessionId=" + sessionId + ", state=AUTHENTICATION_FAILED, loginRequestInfo=TaraSession.LoginRequestInfo(");
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: EXTERNAL_TRANSACTION", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/ocsp, authenticationType=ID_CARD, authenticationState=EXTERNAL_TRANSACTION, authenticationSessionId=%s, errorCode=IDC_OCSP_NOT_AVAILABLE)", sessionId));
        assertStatisticsIsLoggedOnce(ERROR, "Authentication result: AUTHENTICATION_FAILED", format("StatisticsLogger.SessionStatistics(service=null, clientId=openIdDemo, clientNotifyUrl=null, eidasRequesterId=null, sector=public, registryCode=10001234, legalPerson=false, country=EE, idCode=38001085718, subject=EE38001085718, firstName=JAAK-KRISTJAN, lastName=JÕEORG, ocspUrl=https://localhost:9877/ocsp, authenticationType=ID_CARD, authenticationState=AUTHENTICATION_FAILED, authenticationSessionId=%s, errorCode=IDC_OCSP_NOT_AVAILABLE)", sessionId));
    }
