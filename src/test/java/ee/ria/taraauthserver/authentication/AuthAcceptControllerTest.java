...
public class AuthAcceptControllerTest extends BaseTest {
    ...
    void authAccept_incorrectSessionState() {
        ...
        assertErrorIsLogged("User exception: Invalid authentication state: 'INIT_AUTH_PROCESS', expected one of: [AUTHENTICATION_SUCCESS, WEBAUTHN_AUTHENTICATION_COMPLETED, VERIFICATION_COMPLETED, NATURAL_PERSON_AUTHENTICATION_COMPLETED, LEGAL_PERSON_AUTHENTICATION_COMPLETED]");
