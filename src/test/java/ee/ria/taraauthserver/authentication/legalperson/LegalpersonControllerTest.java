...
public class LegalpersonControllerTest extends BaseTest {
    ...
    void postAuthLegalPersonConfirm_validLegalPersonIdentifier() {
        ...
        assertStatisticsIsLoggedOnce(INFO, "Authentication result: AUTHENTICATION_SUCCESS", "StatisticsLogger.SessionStatistics(clientId=openIdDemo, sector=public, registryCode=10001234, service=null, legalPerson=true, country=EE, idCode=ABC-00000000-_abc, ocspUrl=null, authenticationType=MOBILE_ID, authenticationState=AUTHENTICATION_SUCCESS, errorCode=null)");
    }
}
