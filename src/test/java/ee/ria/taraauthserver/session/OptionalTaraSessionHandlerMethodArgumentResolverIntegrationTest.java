...
@Import(OptionalTaraSessionHandlerMethodArgumentResolverIntegrationTest.TestController.class)
class OptionalTaraSessionHandlerMethodArgumentResolverIntegrationTest extends BaseTest {

    public static final String TEST_PATH = "/optional-tara-session-handler-method-argument-resolver";
    ...
    static class TestController {
        ...
        Response endpoint(Optional<TaraSession> taraSessionOptional) {
            TaraSession taraSession = taraSessionOptional.orElseThrow();
