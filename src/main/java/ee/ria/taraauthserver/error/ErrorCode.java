...
public enum ErrorCode {
    ...
    SID_WEB2APP_CALLBACK_SESSION_NOT_FOUND("message.smart-id.error.web2app-callback-session-not-found"),
    SID_WEB2APP_CALLBACK_VALUE_MISMATCH("message.smart-id.error.web2app-callback-value-mismatch"),
    ...
    SID_USER_REFUSED_DISPLAYTEXTANDPIN("message.smart-id.error.user-refused-display-text-and-pin"),
    ...
    AUTH_FLOW_TIMEOUT("message.error.auth-flow-timeout"),
