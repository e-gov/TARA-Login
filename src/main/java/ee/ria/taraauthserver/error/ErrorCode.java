...
public enum ErrorCode {
    ...
    VERIFF_INTERNAL_ERROR("message.veriff.error.internal-error"),
    VERIFF_THREAD_INTERRUPTED_ERROR("message.veriff.error.internal-error"),
    VERIFF_MAX_ATTEMPTS_REACHED_ERROR("message.veriff.error.internal-error"),
    VERIFF_ABANDONED("message.veriff.error.abandoned"),
    VERIFF_EXPIRED("message.veriff.error.expired"),
    VERIFF_DECLINED("message.veriff.error.declined"),
    VERIFF_REVIEW_REQUESTED("message.veriff.error.review-requested"),
    VERIFF_RESUBMISSION_REQUESTED("message.veriff.error.resubmission-requested"),
    VERIFF_NOT_STARTED_ERROR("message.veriff.error.not-started-error"),
