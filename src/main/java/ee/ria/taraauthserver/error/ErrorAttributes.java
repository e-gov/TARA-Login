...
import static ee.ria.taraauthserver.error.ErrorCode.SID_WEB2APP_CALLBACK_SESSION_NOT_FOUND;
import static ee.ria.taraauthserver.error.ErrorCode.SID_WEB2APP_CALLBACK_VALUE_MISMATCH;
...
public class ErrorAttributes extends DefaultErrorAttributes {
    ...
    public static final Set<ErrorCode> notReportableErrors = EnumSet.of(
            ...
            NOT_MID_CLIENT,
            SID_USER_REFUSED,
            SID_WEB2APP_CALLBACK_SESSION_NOT_FOUND,
            SID_WEB2APP_CALLBACK_VALUE_MISMATCH,
            SID_SESSION_TIMEOUT,
            SID_WRONG_VC,
