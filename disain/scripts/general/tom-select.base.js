...
(function (global, factory) {
  ...
  var MicroEvent = /*#__PURE__*/function () {
    ...
    _createClass(MicroEvent, [{
      ...
      value: function off(events, fct) {
        ...
        forEvents(events, function (event) {
          if (n === 1) return delete _this2._events[event];
      ...
      value: function trigger(events) {
        ...
        forEvents(events, function (event) {
          ...
          var _iterator = _createForOfIteratorHelper(self._events[event]),
              _step;
  ...
  function generateDiacritics() {
    ...
    code_points.forEach(function (code_range) {
      for (var i = code_range[0]; i <= code_range[1]; i++) {
        var diacritic = String.fromCharCode(i);
        var latin = diacritic.normalize('NFD').replace(/[\u0300-\u036F]/g, '').normalize('NFKD');
    ...
    _createClass(Sifter, [{
        ...
        var scoreObject = function () {
          ...
          return function (token, data) {
            ...
            if (token.field) {
              ...
              iterate(weights, function (weight, field) {
      ...
      value: function prepareSearch(query, optsUser) {
        ...
        if (options.fields) {
          ...
          if (Array.isArray(options.fields) && _typeof(options.fields[0]) !== 'object') {
            var fields = [];
            options.fields.forEach(function (fld_name) {
              fields.push({
                field: fld_name
              });
            });
          ...
          options.fields.forEach(function (field_params) {
      ...
      value: function search(query, options) {
        ...
        if (query.length) {
          iterate(self.items, function (item, id) {
            score = fn_score(item);
  ...
  function getDom(query) {
    ...
    if (_instanceof(query, HTMLElement)) {
      return query;
    }
  ...
  function getSettings(input, settings_user) {
    ...
    var init_select = function init_select() {
      ...
      var addGroup = function addGroup(optgroup) {
        ...
        var _iterator3 = _createForOfIteratorHelper(optgroup.children),
            _step3;

        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _option = _step3.value;
            addOption(_option, id);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      var _iterator4 = _createForOfIteratorHelper(input.children),
          _step4;
    ...
    var init_textbox = function init_textbox() {
      ...
      if (!data_raw) {
        ...
        var _iterator6 = _createForOfIteratorHelper(settings_element.options),
            _step6;
  ...
  var TomSelect = /*#__PURE__*/function (_MicroPlugin) {
    ...
    function TomSelect(input_arg, settings) {
      var _this5;
      ...
      _this5.settings = getSettings(input, settings);
      _this5.input = input;
      ...
      _this5.sifter = new Sifter(_this5.options, {
        diacritics: _this5.settings.diacritics
      });

      _this5.setupOptions(_this5.settings.options, _this5.settings.optgroups);

      delete _this5.settings.optgroups;
      delete _this5.settings.options; // option-dependent defaults

      _this5.settings.mode = _this5.settings.mode || (_this5.settings.maxItems === 1 ? 'single' : 'multi');

      if (typeof _this5.settings.hideSelected !== 'boolean') {
        _this5.settings.hideSelected = _this5.settings.mode === 'multi';
      }

      if (typeof _this5.settings.hidePlaceholder !== 'boolean') {
        _this5.settings.hidePlaceholder = _this5.settings.mode !== 'multi';
      } // set up createFilter callback


      var filter = _this5.settings.createFilter;
      ...
      if (typeof filter !== 'function') {
        ...
        if (_instanceof(filter, RegExp)) {
          _this5.settings.createFilter = function (input) {
            return filter.test(input);
          };
        } else {
          _this5.settings.createFilter = function () {
            return true;
          };
        }
      }

      _this5.initializePlugins(_this5.settings.plugins);

      _this5.setupCallbacks();

      _this5.setupTemplates();
    ...
    _createClass(TomSelect, [{
      ...
      value: function setup() {
        ...
        dropdown_content = getDom("<div role=\"listbox\" id=\"".concat(listboxId, "\" tabindex=\"-1\">"));
        ...
        addEvent(control_input, 'mousedown', function (e) {
          if (control_input.value !== '') {
            e.stopPropagation();
          }
        });
        addEvent(control_input, 'keydown', function (e) {
          return self.onKeyDown(e);
        });
        addEvent(control_input, 'keyup', function (e) {
          return self.onKeyUp(e);
        });
        addEvent(control_input, 'keypress', function (e) {
          return self.onKeyPress(e);
        });
        addEvent(control_input, 'resize', function () {
          return self.positionDropdown();
        }, passive_event);
        addEvent(control_input, 'blur', function () {
          return self.onBlur();
        });
        addEvent(control_input, 'focus', function (e) {
      ...
      value: function setupOptions() {
        ...
        var _iterator8 = _createForOfIteratorHelper(optgroups),
            _step8;
      ...
      value: function onPaste(e) {
        ...
        if (self.settings.splitOn) {
          ...
          setTimeout(function () {
            ...
            var _iterator9 = _createForOfIteratorHelper(splitInput),
                _step9;
      ...
      value: function load(value) {
        ...
        self.loading++;
        var callback = self.loadCallback.bind(self, value);
      ...
      key: "loadCallback",
      value: function loadCallback(value, options, optgroups) {
        var self = this;
        self.loading = Math.max(self.loading - 1, 0);
        self.lastQuery = null;
      ...
      value: function search(query) {
        ...
        if (self.settings.hideSelected) {
          for (i = result.items.length - 1; i >= 0; i--) {
            var hashed = hash_key(result.items[i].id);
      ...
      value: function refreshOptions() {
        ...
        for (i = 0; i < n; i++) {
          ...
          var opt_value = get_hash(option[self.settings.valueField]);
        ...
        for (var _i2 = 0, _groups_order = groups_order; _i2 < _groups_order.length; _i2++) {
          optgroup = _groups_order[_i2];

          if (self.optgroups.hasOwnProperty(optgroup) && groups[optgroup].children.length) {
            var group_options = document.createDocumentFragment();
            var header = self.render('optgroup_header', self.optgroups[optgroup]);
        ...
        if (self.settings.highlight) {
          ...
          if (results.query.length && results.tokens.length) {
            var _iterator10 = _createForOfIteratorHelper(results.tokens),
                _step10;

            try {
              for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
                var tok = _step10.value;
      ...
      value: function updateOption(value, data) {
        ...
        var value_new = hash_key(data[self.settings.valueField]);
        var option = self.getOption(hashed);
        var item = self.getItem(hashed); // sanity checks
      ...
      value: function uncacheValue(value) {
        var remove_node = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
        var self = this;
        ...
        if (remove_node) {
          var option_el = self.getOption(value);
      ...
      value: function getItem(item) {
        ...
        return value ? this.control.querySelector("[data-value=\"".concat(addSlashes(value), "\"]")) : null;
      }
      /**
      ...
      value: function addItems(values, silent) {
        ...
        var _iterator12 = _createForOfIteratorHelper(self.control.children),
            _step12;
      ...
      value: function createItem() {
        ...
        var triggerDropdown = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      ...
      value: function updateOriginalInput() {
        ...
        if (self.is_select_tag) {
          ...
          self.input.querySelectorAll('option[selected]').forEach(function (option_el) {
            var _opt = option_el;
      ...
      value: function deleteSelection(e) {
        ...
        if (self.activeItems.length) {
          ...
          var _iterator14 = _createForOfIteratorHelper(self.activeItems),
              _step14;
        ...
        var values = rm_items.map(function (item) {
      ...
      key: "rendered",
      value: function rendered(templateName, value) {
